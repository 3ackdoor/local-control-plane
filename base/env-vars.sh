...
# export GCP_ZONE_2=asia-northeast1-b

# # Network
# export GKE_NETWORK_NAME_2=gl-alpha-nw-1

# # Subnet
# export GKE_SUBNET_NAME_2=gl-alpha-subnet-1
# export GKE_CLUSTER_SECONDARY_RANGE_NAME=gl-alpha-pods
# export GKE_SERVICES_SECONDARY_RANGE_NAME=gl-alpha-services
...
# # Cluster
# export GKE_CLUSTER_NAME_2=gl-alpha-private-controller-cluster-1
# export GKE_SUBNET_NAME_FULL_PATH_2=projects/$GCP_PROJECT/regions/$GCP_REGION_2/subnetworks/$GKE_SUBNET_NAME_2
# export GKE_NETWORK_NAME_FULL_PATH_2=projects/$GCP_PROJECT/global/networks/$GKE_NETWORK_NAME_2
# export GKE_ZONE=asia-southeast1-b ## Actually, you can use $GCP_ZONE
# export GKE_NODE_LOCATIONS_2=asia-northeast1-b
# export GKE_MACHINE_TYPE=e2-custom-2-8192
# export GKE_NUM_NODES=3 # default=3
# export GKE_MAX_PODS_PER_NODE=50
# export GKE_MASTER_IPV4_CIDR=172.16.0.0/28
